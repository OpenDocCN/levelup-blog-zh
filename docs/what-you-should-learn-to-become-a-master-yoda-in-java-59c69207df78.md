...
> 原文：<https://levelup.gitconnected.com/what-you-should-learn-to-become-a-master-yoda-in-java-59c69207df78>

所以你决定成为一名爪哇绝地…你前面的路还很长。

![](img/46ac4af1c688c90f96bb637daf5820ad.png)
...
![](img/d16ff2ce0b7a3f665e15b04aaff17764.png)
...
OOP 不是世界上最难的话题，但却极其重要。阅读和实践 OOP 原则都很重要。

类继承、接口实现、数据和行为的抽象、数据和类实现的封装、多态和虚方法都是关键主题。实践这些概念并阅读书籍(例如，凯·霍斯特曼，加里·科内尔*的《核心 Java 》,麦克劳克林的《面向对象的分析与设计》*)。
...
异常(或异常事件)是在程序执行过程中出现的异常情况。这种机制极大地简化了程序中的 bug 捕获。所有异常类都是`java.lang.Exception`类的子类型，每个 Java 学生都应该非常了解它。

## 级别 4:输入/输出流

Java 通过流执行输入和输出操作。你可以把一个流想象成一个连续的数据流。这个话题对初学者来说可能会有问题。学习这个话题的一个好处是你发现了`System.out.println()`的真正含义。

![](img/2ab078de03f2f56f6a9c312ad01d48cb.png)
...
![](img/a4ddcf52e5952ea25c2364cf712072e3.png)

CodeGym —这是一门 Java 核心课程，包含 1000 多个带验证的编码任务。

![](img/2794e2c87276da1abd38c8cc6cea689a.png)

[w3 resource](https://www.w3resource.com/java-exercises/basic/index.php)——一个非常著名的优秀网站。

[GeeksForGeeks](https://www.geeksforgeeks.org/tag/java-puzzle/) (尤其是算法和谜题)——非常好的资源，有许多任务和不同的课程。

![](img/0feac65fca55798a0a8e3f2554b9ccc2.png)

# 第二步:附加产品

Java developer 不仅使用 Java，还使用许多不同的技术。其中一些成为了每个人的标准。然而，这并不意味着你必须像了解 Java 核心那样了解这些技术。多学一点，其中一些你会在工作或实习期间发现得更好。

**Git。这是最广泛使用的版本控制系统，用于跟踪计算机文件的变化，并协调多人对这些文件的工作。所以如果你想成为一名职业程序员，理解 Git 是一个要求。几乎每个软件公司都使用它。**

在这里学习:[学习 Git 分支](https://learngitbranching.js.org/)或者在这里:[什么是 Git](https://www.atlassian.com/git/tutorials/what-is-git)

[](https://gitconnected.com/learn/git) [## 学习 Git -最佳 Git 教程(2019) | gitconnected

### 前 42 个 Git 教程。课程由开发人员提交和投票，使您能够找到最好的 Git 课程和…
...
**SQL** 。Wikipedia 将其定义为“结构化查询语言是一种特定于领域的语言，用于编程，旨在管理关系数据库管理系统(RDBMS)中的数据，或用于关系数据流管理系统(RDSMS)中的流处理。”在初级水平上学习它是相当容易的。几乎每个程序员都在某个时候使用过 SQL。

![](img/e3fc949e91343e7374f97d09f53eda50.png)

在这里了解: [SQLBolt](https://sqlbolt.com/) 或者在这里 [w3schools](https://www.w3schools.com/sql/)

[](https://gitconnected.com/learn/sql) [## 学习 SQL -最佳 SQL 教程(2019) | gitconnected

### 27 大 SQL 教程。课程由开发人员提交和投票，使您能够找到最好的 SQL 课程和…
...
Java 知识为你打开了 Android 开发的世界。学习 Android 编程的好地方:[谷歌开发人员培训](https://developers.google.com/training/android/)
...
这由一堆自己很难学会的技术组成。最好是找课程或者实习。了解最流行的 Java 框架`Spring`和对象关系映射[工具](https://en.wikipedia.org/wiki/Object-relational_mapping)以及其他相关技术是有益的，它们将在本*免费* [Udemy 课程](https://www.udemy.com/spring-framework-video-tutorial/?siteID=JVFxdTr9V80-8SNbhyaiGnts0o5GwK6r0A&LSNPUBID=JVFxdTr9V80&ranMID=39197&ranEAID=JVFxdTr9V80&ranSiteID=JVFxdTr9V80-lqn8XpZwLpTwnFaL6r.tFQ&LSNPUBID=JVFxdTr9V80)中讲授。
...
### 38 大 Java 教程。课程由开发人员提交并投票，使您能够找到最好的 Java 课程…
