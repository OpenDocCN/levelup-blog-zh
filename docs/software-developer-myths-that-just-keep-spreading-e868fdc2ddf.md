...
从我的角度来看，**就像软件开发中的所有事情一样，必须为正确的工作使用正确的工具，这也适用于招聘流程**。我们应该问自己的第一个问题是，对于那个特定的候选人，编码测试有意义吗？你应该对一个有多年软件开发经验的人进行现场代码测试吗？如果是，这是否反映了日常现实？如果答案是否定的，那么我们为什么要这样做？我见过许多从研究生到高级工程师都在与现场代码练习作斗争。原因有很多:
...
没有一家公司(除非是非常小的公司，或者是自有公司)有足够的钱只雇佣资深员工。句号。甚至很多创业公司除了大四什么都开始。马克的第一次脸书迭代在代码质量方面是一堆垃圾，但嘿，它工作了。在许多方面，他甚至可能不符合初级软件工程师的要求，但没人会问你什么时候在构建自己的东西。

没有初级角色就不可能有高级角色，就像没有种子就不可能有树一样。问题不在于缺少角色，而在于对年轻人的期望。**在 3 个月的 MERN 训练营之后，期望 6 位数的薪水既荒谬又无礼。**抱怨你花了 15，000 英镑参加训练营，却没有人认真对待你，就像在大学里学了一学期，除了在想雇用你的公司外面排队。当我得到我的第一份初级软件开发员的工作时，我只要求比我以前做客户支持代理的薪水多几千美元。我想进入这个行业，成长，这样下次当我有机会要求更多的时候，我就有理由这样做。

**事实是，无数公司喜欢年轻员工，想要年轻员工，他们在录取标准方面非常宽松。**他们对技能的期望很低，这通常取决于你是否是一个希望成长、容易共事的人。

## 你必须知道最新最棒的库和框架

你不知道，但我承认有一些公司在进行血汗工厂式的开发，通常是代理公司，他们只雇佣 React、Vue、Express 或其他最新最好的工程师。所以，这是有一定道理的，但是**许多有自尊的公司知道跨职能软件开发技能的价值**，所以他们要么关注某些语言，要么完全忽略这种语言，只关注好的编程技能。

我曾经有一个很好的朋友，做了三年的 PHP 开发。一天，他穿着短裤和拖鞋去面试，他们告诉他这是一个非常棒的角色。他对框架一无所知，但他们还是雇佣了他。当他问，他是怎么得到这个角色的，他们告诉他，语言和框架是不相关的，他们认为他是一个优秀的程序员和解决问题的人，他会在工作中发现任何新的东西。他们是对的。几个月后，他精通了 Ruby 和 Rails，就像他精通 PHP 一样。

## 谷歌搜索不好

高度依赖上下文。如果你在谷歌上搜索如何用你可能用了 5 年的语言写一个函数，我会有一个问题，不是关于你的编码技能，而是你的撒谎技能。

除此之外，任何告诉我他们不谷歌东西的网络开发者都在撒谎。让我们坦率地说。任何类型的工程师，不仅仅是软件工程师，通常都必须依赖文档。这是工作的一部分。这些技能是知道要搜索什么，以及一旦找到如何使用它。

## 一个比另一个好

真实的故事。工程师无法停止谈论兰姆达斯。AWS 那种。他们信誓旦旦地说是函数式编程，但当被问及为什么它比面向对象编程更好时，当被问及遗留(三年前)代码库中的问题时，他们只会喋喋不休地说他们如何在 AWS this 和 AWS that 中实现它。

这里的问题不是他们拥有高度专业化的 AWS 技能，而是他们不了解也不关心替代方案。**作为一名软件工程师，你的资历越深，你就越有可能小心翼翼地在真空中称某样东西比其他东西更好。**答案总是要考虑许多层面的背景，如团队技能、资源、遗留代码、业务目标、招聘等。上下文，妈的！语境！😁

## 没人想要老工程师

或者……也许老工程师很满意他们的现状，决定提前退休，或者已经晋升到工程总监、副总裁和首席技术官的级别。**许多工程师只是不想一辈子写代码**，这又回到了我关于职业转换者的另一个观点。

例如，我发现让我对软件工程保持兴趣的是技术、编程语言、库、框架的各种进步和需要解决的新挑战。基于此，**我确实看到自己在 45 岁**(到 2022 年我将 37 岁)时仍在以某种形式编码，或者在一般意义上称自己为软件工程师。但是我也想在 50 岁退休，也许开始自己的事业，住在世界上更多的地方。

我和很多 40 岁以上的工程师一起工作过，他们都是很好的合作伙伴(除了一个),从来没有抱怨过没有足够的机会。如果有的话，他们有太多，他们不断拒绝招聘人员。

## 软件工程师的薪酬过高

或许，更像世界上的其他地方，收入严重不足。**在什么情况下，一名护士可以拿到高级软件工程师工资的 30%**？对吗？那会让事情变得更好看，不是吗？我认为世界上许多国家(但遗憾的是，不是所有国家)的软件工程师的工资都很合理。我认为软件工程师的生活方式是每个人都能负担得起的。

## 和一些俏皮话

*   我们都戴着耳机和帽衫。我打赌戴着耳机和帽衫的说唱歌手会更多。我们尽可能穿舒适的衣服，就像大多数人一样。耳机是办公室用品。在家工作改变了很多。
*   **我们都是科幻迷、游戏玩家，对《星球大战》了如指掌。就我而言，我知道很多人既不玩游戏，也不关心星球大战。此外，我最喜欢的电影类型是浪漫喜剧和音乐剧。**
*   **我们知道关于电脑的一切。没有人对电脑了如指掌。也许甚至不是蒂姆·伯纳斯·李爵士，虽然我还没有证实。不过，我的分析型逻辑工程师头脑有一种“直觉”，认为我是对的。**
*   软件开发是一场香肠盛宴。其实不是。这些年来，我和许多优秀的女性软件工程师一起工作过，现在仍然如此，我们中的绝大多数人都欢迎这种多样性。
*   **编码员没有创造力。想打赌吗？到目前为止，我见过和共事过的大多数人都有某种形式的创造力，无论是设计、音乐、艺术、写作等等。**
*   **我们总是处于“最佳状态”。**是的，其他需要专注于自己工作并享受工作的人也是如此。问问外科医生，艺术家，牧师，F1 车手，老师等等。处于最佳状态不是程序员该做的事情。从来都不是。
*   我们都可以黑东西。毕竟，我们做黑客马拉松，不是吗？不。大多数软件开发人员不知道如何入侵。当然，我们可以学，但是如果玛丽阿姨愿意的话，她也可以从马路对面学。
*   **敏捷解决一切。**并没有。它只是创建了一个更有效的开发结构，但是在敏捷中仍然有很多问题需要解决。
*   成为首席工程师后，唯一可行的晋升途径是成为经理。完全不真实。继续做校长，或者成为一名建筑师也是一个选择，看看史蒂夫·沃兹尼亚克。也可以退休，做自己的事。
